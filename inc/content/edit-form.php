<div class="wrap">
    <h1 class="wp-heading-inline">Edit Tiger Form</h1>
    <a href="admin.php?page=tiger-forms-add-new" class="page-title-action">Add New</a>
    <hr class="wp-header-end">
    <div class="error-occured">

    </div>
    <?php
    if (get_transient('dfu-form-insert-success')) {
        ?>
        <div class="notice notice-success is-dismissible">
            <p>Form created successfully.</p>
        </div>
        <?php
        delete_transient('dfu-form-insert-success');
    }

    if (get_transient('dfu-form-update-success')) {
        ?>
        <div class="notice notice-success is-dismissible">
            <p>Form updated successfully.</p>
        </div>
        <?php
        delete_transient('dfu-form-update-success');
    }

    global $wpdb;
    $table_name = $wpdb->prefix . 'posts';
    $table_name_msg = $wpdb->prefix . 'tiger_forms_main';
    $getId = intval($_GET['post']);

    $checkId = $wpdb->get_var("SELECT COUNT(ID) FROM $table_name  WHERE post_type = 'tiger_form' AND ID = '$getId' ");
    if ($checkId == 1) {
    $getResults = $wpdb->get_row("SELECT post_title, post_content FROM $table_name WHERE post_type = 'tiger_form' AND ID = '$getId'");
    $getMsg = $wpdb->get_row("SELECT form_messages, notification, notification_email FROM $table_name_msg WHERE Form_Post_Id = '$getId'");
    $exploding = explode("-", $getMsg->form_messages);
    ?>
    <form action="" method="POST" class="dfu-form-main-update" name="dfu-form-main-update">
        <input type="hidden" name="dfu-nonce" id="wp_nonce"
               value="<?php echo wp_create_nonce('dfu-validate-my-edited-nonce'); ?>">
        <div id="poststuff">
                ...
                <div id="post-body-content" style="position: relative;">
                    <div id="titlediv">
                        <div id="titlewrap">
                            ...
                            <input type="text" name="data_form_title_up" size="30" placeholder="Enter Your Title Here"
                                   value="<?php echo $getResults->post_title; ?>" id="title" spellcheck="true"
                                   autocomplete="off">
                        </div>
                    </div>
                    <div class="shortcode-content">
                        <label>For post, page, or text widget content, copy this shortcode and paste it:</label>
                        <input type='text' name='shortcode-generate'
                               value='[tiger-form id="<?= $getId; ?>" title="<?= $getResults->post_title; ?>"]'
                               class='shortcode-input-row post-shortcode' disable>
                    </div>
                    <div class="shortcode-content">
                        <label>For PHP code snippet, copy this shortcode and paste it into your themes:</label>
                        <input type='text' name='shortcode-generate'
                               value='echo do_shortcode(&#39;[tiger-form id="<?= $getId; ?>" title="<?= $getResults->post_title; ?>"]&#39;);'
                               class='shortcode-input-row post-shortcode' disable>
                    </div>
                    <div class="data-form-ultimate-content ">
                        <div class="form-tab">
                            <ul>
                        ...
                        <div class="form-content-common" id="form" oncontextmenu="return false">
                            ...
                            <div class="data-form-content-inner content-form-demo">
                                <div class="difu-form-demo edit-demo-form">
                                    <?php $splitForm = explode('[', $getResults->post_content);
                                    $count = 0;
                                    foreach ($splitForm as $value) {
                                        $count++;
                                        if ($count > 1) {
                                            $getType = $tiger_form_materials->tiger_form_field_type($value);
                                            $generateNumber = mt_rand(15, 1000);
                                            $combineTypeNumber = $getType . '-' . $generateNumber;
                                            ?>
                                            <div class="demo-field-block" id="<?= $combineTypeNumber; ?>">
                                                <?php
                                                echo do_shortcode('[' .$tiger_form_materials->tiger_form_shortcode_validate_error($value));
                                                ?>
                                                <input type="hidden" class="shortcode-combine"
                                                       value="<?php echo '[' . $tiger_form_materials->tiger_form_shortcode_validate_error($value); ?>">
                                            </div>
                                            <?php
                                        }
                                    }
                        ...
                        <input type="hidden" id='formid' name="formid" value="<?= $getId; ?>">
                        <div class="form-content-common" id="messages" style="display: none;"
                            ...
                            <div class="data-form-content-inner">
                                ...
                                <input type="text" name="successful-msg-up" value="<?= esc_html($exploding[0]) ?>"
                                       maxlength="250" class="msg" id="success-msg">
                                <label>If data failed to send</label>
                                <input type="text" name="faild-msg-up" value="<?= esc_html($exploding[1]) ?>"
                                       maxlength="250" class="msg" id="failed-msg">
                                <label>If validation errors occurred</label>
                                <input type="text" name="error-msg-up" value="<?= esc_html($exploding[2]) ?>"
                                       maxlength="250" class="msg" id="error-msg">
                                <label>Field must fill in</label>
                                <input type="text" name="required-msg-up" value="<?= esc_html($exploding[3]) ?>"
                                       maxlength="250" class="msg" id="required-msg">
                                <label>If email that sender entered is invalid format</label>
                                <input type="text" name="email-invalid-msg-up" value="<?= esc_html($exploding[4]) ?>"
                                       maxlength="250" class="msg" id="email-msg">
                                <label>If URL that the sender entered is invalid</label>
                                <input type="text" name="url-invalid-msg-up" value="<?= esc_html($exploding[5]) ?>"
                                       maxlength="250" class="msg" id="url-msg">
                                <label>If Number is larger than maximum limit</label>
                                <input type="text" name="number-max-msg-up" value="<?= esc_html($exploding[6]) ?>"
                                       maxlength="250" class="msg" id="number-msg-1">
                                <label>If Number is smaller than minimum limit</label>
                                <input type="text" name="number-min-msg-up" value="<?= esc_html($exploding[7]) ?>"
                                       maxlength="250" class="msg" id="number-msg-2">
                            </div>
                        </div>
                        <div class="form-content-common" id="notify" style="display: none;"
                            ...
                            <?php
                            if ($getMsg->notification == 'yes') {
                                ?>
                                <div class="data-form-content-inner">
                                    <label style="display: block;">Send me notification email when data
                                        inserted </label>
                                    <input type="checkbox" name="notify-allow-up" value="yes" class="dfu-notification"
                                           style="width: 10px; margin-left: 10px; margin-top: 8px;" checked>
                                    <div class="notify-hidden" style="display: block; margin-top: 15px;">
                                        <label>Enter email address</label>
                                        <input type="email" name="notify-email-up"
                                               value="<?= $getMsg->notification_email; ?>" class="notify-email">
                                    </div>
                                </div>
                                <?php
                            } else {
                                ...
                                <div class="data-form-content-inner">
                                    ...
                                    <div class="notify-hidden" style="display: none; margin-top: 15px;">
                                        <label>Enter email address</label>
                                        <input type="email" name="notify-email-up" value="" class="notify-email">
                                    </div>
                                </div>
                                <?php
                            }
                    ...
                    <div id="side-sortables" class="meta-box-sortables ui-sortable" style="">
                                ...
                                <div class="submitbox" id="submitpost">
                                    ...
                                    <div id="major-publishing-actions">
                                        <div id="delete-action">
                                            <span class="spinner spinner-delete"></span>
                                            <button type="button" class="delete dfu-form-delete" name="dfu-form-delete">
                                                <span class="dashicons dashicons-trash"></span>Delete
                                            </button>
                                        </div>
                                        <div id="publishing-action">
                                            <span class="spinner spinner-update"></span>
                                            <button type="button" class="button-primary dfu-form-update"
                                                    name="dfu-form-update"> Update
                                            </button>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                        ...
                        <div id="informationdiv" class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <ol>
                                    <li><a href="https://wordpress.org/plugins/tiger-form/" target="_blank">FAQ</a> and
                                        <a href="https://wordpress.org/plugins/tiger-form/" target="_blank">docs</a>
                                    </li>
                                    <li>Developer Support: <a
                                                href="mailto:jakirhosen@yahoo.com">jakirhosen@yahoo.com</a></li>
                                </ol>
                            </div>
                        </div>
                        <div id="informationdiv" class="postbox">
                ...
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="text-field-label"
                                                 class="label-field text-common-feild difu-field-reset" data-type="text"
                                                 data-field="label">
                        </td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="text-field-name"
                                                 class="name-field text-name-field difu-field-reset" data-type="text"
                                                 value=""></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="text-field-value"
                                                 class="value-field text-common-feild difu-field-reset" data-type="text"
                                                 data-field="value"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="text-field-class"
                                                 class="class-field text-common-feild difu-field-reset" data-type="text"
                                                 data-field="class"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="checkbox" name="text-field-unique" data-type="text"
                                                 class="unique-field text-common-feild difu-field-reset-check" value=""
                                                 data-field="unique"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                ...
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="email-field-label"
                                                 ...
                                                 data-type="email" data-field="label">
                        </td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="The label element appear above an input field. It specifies a hint that describes the expected value of input element."
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="email-field-name"
                                                 class="name-field email-name-field difu-field-reset" data-type="email"
                                                 value=""></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="The field name will be appearing on your table column name."
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="checkbox" name="email-field-unique" data-type="email"
                                                 class="unique-field email-common-feild difu-field-reset-check" value=""
                                                 data-field="unique"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="If you checked this box, only unique data will be inserted in the column in this field."
    ...
    <div class="hidden-div" id="url" style="display: none;" oncontextmenu="return false">
        <div class="hidden-content">
                ...
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="url-field-label"
                                                 class="label-field url-common-feild difu-field-reset" data-type="url"
                                                 data-field="label">
                        </td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="url-field-value"
                                                 class="value-field url-common-feild difu-field-reset" data-type="url"
                                                 data-field="value"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="Default value specifies the value of an input element."
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="checkbox" name="url-field-readonly" data-type="url"
                                                 class="readonly-field url-common-feild difu-field-reset-check" value=""
                                                 data-field="readonly"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="It specifies that an input field is read-only. A read-only input field cannot be modified."
                                               class="hint-icon"></td>
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="url-field-class"
                                                 class="class-field url-common-feild difu-field-reset" data-type="url"
                                                 data-field="class"></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="The class attribute specifies one or more classnames to the field."
            ...
            <div class="insert-content-data">
                ...
                <button type="button" data-type="url" class="btn btn-primary difu-fieldInsertionbtn url-fieldInsertion">
                    Insert Field
                </button>
            </div>
        </div>
                ...
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="date-field-label"
                                                 class="label-field date-common-feild difu-field-reset" data-type="date"
                                                 data-field="label">
                        </td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2"><input type="text" name="date-field-name"
                                                 class="name-field date-name-field difu-field-reset" data-type="date"
                                                 value=""></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="The field name will be appearing on your table column name."
                ...
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-2">Min <input type="number" name="number-field-max"
                                                     ...
                                                     data-type="number" data-field="max" style="width: 60px;"> -- Max
                            <input type="number" name="number-field-min"
    ...
    <div class="hidden-div" id="textarea" style="display: none;" oncontextmenu="return false">
        <div class="hidden-content">
            ...
            <div class="dfu-content-inner">
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        <td class="cel-1"><label>Field is Required:</label></td>
                        <td class="cel-2">
                            <input type="checkbox" name="textarea-field-required" data-type="textarea"
                                   class="required-field difu-field-reset-check">
                        </td>
                        <td class="cel-3">
                            <img src="<?php $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                 alt="info icon"
                                 data-info="It specifies that input field must be filled out before submitting the form."
                                 class="hint-icon">
                        </td>
            ...
            <div class="insert-content-data">
                ...
                <input type="hidden" value="[dfu_textarea" id="textarea-data-contain1" class="field-reset-shortcode">
            ...
            <div class="dfu-content-inner">
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon" data-info="The label element appear above select field."
                                               class="hint-icon"></td>
                    </tr>
                    <tr scope="row">
                        <td class="cel-1"><label>Field Name:</label></td>
    ...
    <div class="hidden-div" id="radio" style="display: none;" oncontextmenu="return false">
        <div class="hidden-content">
            ...
            <div class="dfu-content-inner">
                <table class="dfu-jquery-action-table">
                    ...
                    <tr scope="row">
                        ...
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon" data-info="The label element appear above radio field."
                                               class="hint-icon"></td>
                    </tr>
                    <tr scope="row">
                        <td class="cel-1"><label>Field Name:</label></td>
                        <td class="cel-2"><input type="text" name="radio-field-name"
                                                 class="name-field radio-name-field difu-field-reset" data-type="radio"
                                                 value=""></td>
                        <td class="cel-3"><img src="<?php  $tiger_form_materials->tiger_form_info_icon_produce(); ?>"
                                               alt="info icon"
                                               data-info="The field name will be appearing on your table column name."
            ...
            <div class="insert-content-data">
                ...
                <input type="hidden" name="radio-field-shortcode" value="[dfu_radio"
    ...
    <div class="hidden-div" id="checkbox" style="display: none;" oncontextmenu="return false">
        <div class="hidden-content">
            ...
            <div class="insert-content-data">
                ...
                <input type="hidden" value="[dfu_checkbox]" id="checkbox-data-contain1" class="field-reset-shortcode">
